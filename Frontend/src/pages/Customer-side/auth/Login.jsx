...
function Login() {
    ...
    return (
        <AuthLayout
            ...
            testimonial={{
                quote: 'I love how easy it is to discover new restaurants and get the best offers!',
                name: 'MPANO Curie',
                role: 'Food lover',
            }}
            navText="Don't have an account?"
            navLinkLabel="Sign Up"
            navLinkTo="/Customer-side/Signup"
        >
                ...
                <div className="flex items-center justify-between">
                    <label className="flex items-center gap-2 text-sm text-[#374151]">
                        <input
                            ...
                            className="h-4 w-4 rounded border-gray-300 text-[#14532D] accent-[#14532D]"
                        />
                        Remember me
                    </label>
                    <Link to="/Customer-side/ResetPassword" className="text-sm font-medium text-[#14532D] hover:underline">
                        Forgot password?
                    </Link>
                </div>
            ...
            <p className="mt-6 flex items-center justify-center gap-1.5 text-xs text-gray-500">
                <LockKeyhole size={12} />
                Secure login protected by <span className="font-semibold text-[#111827]">Plateform</span>
            </p>
        </AuthLayout>
    )
}
