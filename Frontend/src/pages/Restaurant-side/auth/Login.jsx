...
function Login() {
    ...
    return (
        <AuthLayout
            ...
            testimonial={{
                quote: 'Plateform helps us focus on what matters most, our customers.',
                name: 'UWASE Ariella',
                role: 'Restaurant owner',
            }}
            navText="Don't have an account?"
            navLinkLabel="Sign Up"
            navLinkTo="/Restaurant-side/Signup"
        >
            ...
            <form className="mt-6 space-y-4">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <Link to="/Restaurant-side/ResetPassword" className="text-sm font-medium text-[#14532D] hover:underline">
                        Forgot password?
                    </Link>
                </div>
